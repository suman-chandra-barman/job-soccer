...
interface ICollegePlayerProfessionalInfoFormProps {
  onNext: (data: TCollegePlayerProfessionalInfo) => void;
  onPrev: () => void;
  initialData?: Partial<TCollegePlayerProfessionalInfo>;
  steps?: Array<{
    id: number;
    label: string;
    completed?: boolean;
...
export function CollegePlayerProfessionalInfoForm({
  onNext,
  onPrev,
  initialData,
  steps,
}: ICollegePlayerProfessionalInfoFormProps) {
  const {
    register,
    handleSubmit,
    setValue,
  ...
  } = useForm<TCollegePlayerProfessionalInfo>({
    resolver: zodResolver(collegePlayerProfessionalInfoSchema),
    defaultValues: initialData,
    mode: "onChange",
  });

  const onSubmit = (data: TCollegePlayerProfessionalInfo) => {
    onNext(data);
  };
